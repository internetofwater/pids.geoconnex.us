...
function ozh_404_if_not_found() {
    ...
    $notfound = '<!DOCTYPE HTML PUBLIC "-//IETF//DTD HTML 2.0//EN">'
              ...
              . '</head><body>'
              . '<h1>Not Found</h1>'
              . '<p>The requested URI was not registered. See 
<a href="https://github.com/internetofwater/geoconnex.us/blob/master/CONTRIBUTING.md">the Geoconnex contribution guide</a> to register the desired PID as a geoconnex URI.</p>'
              . '</body></html>';
    die($notfound);
}
